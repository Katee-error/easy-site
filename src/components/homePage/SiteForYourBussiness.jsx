      ...
      <Container maxW={"container.xl"}>
        ...
        <SimpleGrid columns={2} gap={"90px"}>
          <VStack alignItems={"start"} spacing={3}>
            ...
            >
              С 2008 года мы успешно выводим сайты в ТОП поисковых систем. За
              это время реализовано свыше 350 успешных проектов, охватывающих
              различные отрасли бизнеса.
            </Text>
          </VStack>
          <VStack alignItems={"start"} spacing={3}>
            <CircularProgress
