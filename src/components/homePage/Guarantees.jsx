            ...
            <CardBody pt={"0"} pb={"40px"}>
              <Stack mt="6" spacing="3">
                <HStack justifyContent={"space-between"}>
                  <Text fontSize="30px" fontWeight={600} color={"brand.header"}>
                    Разработка сайтов
                  </Text>
                  <Flex
                    h={"50px"}
                ...
                <Text
                  ...
                  fontWeight={500}
                >
                  Руководитель продвижения и персональный менеджер всегда на
                  связи, чтобы обеспечить вам постоянную поддержку и быстрое
